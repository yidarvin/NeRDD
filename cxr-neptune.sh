declare -r path_train=/home/dnr/Documents/data/NeRDD/training
...
python /home/dnr/FirstAid/train_CNNclassification.py --pTrain $path_train --pVal $path_val --pModel $path_model --pLog $path_log --name $name --nGPU 4 --bs 128 --ep 50000 --nClass 3 --lr 0.001 --do 0.5
