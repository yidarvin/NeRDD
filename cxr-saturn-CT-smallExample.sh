...
declare -r path_train=/media/dnr/Documents/data/NeRDD/CXRsmall/training
declare -r path_test=/media/dnr/Documents/data/NeRDD/CXRsmall/testing
declare -r path_val=/media/dnr/Documents/data/NeRDD/CXRsmall/validation
